...
function generateRevenueData(bar: Bar): { time: string; actual: number; predicted: number }[] {
  ...
  const jitter: Record<string, number[]> = {
    'bar-1': [1.01, 0.99, 1.02, 0.98, 1.04, 0.97, 1.03, 0.99, 1.02, 0.98, 1.01, 1.00],
    'bar-2': [0.99, 1.02, 0.97, 1.03, 0.97, 1.04, 0.98, 1.02, 0.97, 1.03, 0.99, 1.00],
    'bar-3': [1.02, 0.97, 1.03, 0.98, 1.02, 0.97, 1.03, 0.98, 1.01, 0.98, 1.01, 1.00],
    'bar-4': [0.97, 1.03, 0.96, 1.04, 0.95, 1.05, 0.96, 1.03, 0.97, 1.04, 0.98, 1.00],
  }
