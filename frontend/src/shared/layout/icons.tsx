/**
 * icons.tsx — shared icon set for sidebars.
 *
 * Extracted from Sidebar.tsx to break a circular import between
 * Sidebar → EventSidebar → Sidebar (ICONS). Both sidebars now import
 * from here instead.
 */
